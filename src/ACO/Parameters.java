...
final class Parameters {
    ...
    static final int NUMBER_OF_ANTS = 25;
    ...
    private static final int AVERAGE_PATH_LENGTH_TO_DESTINATION = 25;
    static final int MAX_EDGE_WEIGHT = 20;
    static final int MAX_CONNECTIONS_BETWEEN_NODES = VERTEX_NUMBER/4;

    static final double PHEROMONE_0 = Math.pow(AVERAGE_PATH_LENGTH_TO_DESTINATION *VERTEX_NUMBER, -1);
